...
dot_batch4_loop8:
	...
	VLD1.P	16(R4), [V12.S4]
	VLD1.P	16(R5), [V13.S4]
	WORD	$0x4E29CD40 // FMLA V0.4S, V10.4S, V9.4S
	WORD	$0x4E29CD61 // FMLA V1.4S, V11.4S, V9.4S
	WORD	$0x4E29CD82 // FMLA V2.4S, V12.4S, V9.4S
	WORD	$0x4E29CDA3 // FMLA V3.4S, V13.4S, V9.4S
